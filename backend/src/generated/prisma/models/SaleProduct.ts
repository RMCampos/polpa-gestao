...
export type GetSaleProductGroupByPayload<T extends SaleProductGroupByArgs> = Prisma.PrismaPromise<
  Array<
...
export type SaleProductWhereInput = {
  ...
  saleId?: Prisma.UuidFilter<"SaleProduct"> | string
  productId?: Prisma.UuidFilter<"SaleProduct"> | string
...
export type SaleProductWhereUniqueInput = Prisma.AtLeast<{
  saleId_productId?: Prisma.SaleProductSaleIdProductIdCompoundUniqueInput
  AND?: Prisma.SaleProductWhereInput | Prisma.SaleProductWhereInput[]
  OR?: Prisma.SaleProductWhereInput[]
  NOT?: Prisma.SaleProductWhereInput | Prisma.SaleProductWhereInput[]
  saleId?: Prisma.UuidFilter<"SaleProduct"> | string
...
export type SaleProductScalarWhereWithAggregatesInput = {
  ...
  saleId?: Prisma.UuidWithAggregatesFilter<"SaleProduct"> | string
  productId?: Prisma.UuidWithAggregatesFilter<"SaleProduct"> | string
...
export type SaleProductOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"saleId" | "productId" | "quantity" | "createdAt" | "updatedAt", ExtArgs["result"]["saleProduct"]>
...
export interface SaleProductDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const saleProductWithSaleIdOnly = await prisma.saleProduct.findMany({ select: { saleId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many SaleProducts and only return the `saleId`
   * const saleProductWithSaleIdOnly = await prisma.saleProduct.createManyAndReturn({
   *   select: { saleId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more SaleProducts and only return the `saleId`
   * const saleProductWithSaleIdOnly = await prisma.saleProduct.updateManyAndReturn({
   *   select: { saleId: true },
   *   where: {
   *     // ... provide filter here
   *   },
